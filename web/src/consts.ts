...
export const FEATURES_SHIPPING = [
  ...
  },
  {
    ...
    desc: "Embeddings and retrieval run on the Apple Neural Engine, so indexing and search stay silent and painless, never hogging your CPU.",
  },
  {
    title: "Codebase intelligence",
    desc: "SQLite-backed index plus HNSW vector retrieval over files, symbols, and chunks: grounded answers drawn from your own code.",
  },
  {
...
export const COMPETITIVE = [
  ...
  { need: "Embeddings & RAG", cloud: "Cloud-bound, code ships out", us: "On-device, Apple Neural Engine" },
  {
    ...
    us: "Same orchestration with your provider, your key, your cost",
  },
...
export const FAQ = [
  {
    ...
    a: "Agentic quality is the model you bring. Compass gives you the orchestration (Planner → Worker → QA with 20+ tools and stall detection), and you choose the brain: OpenRouter, Kilo, DeepSeek, Alibaba, or any OpenAI-compatible endpoint. Bring the best model in the world; we run it at native speed. Our orchestration is open and harness-tested, and the tests are in the repo.",
  },
  {
  ...
  },
  {
    ...
    a: "Compass is the editor I use every day to build itself. It's MIT, so even if I vanished tomorrow, it's yours, forever. I'm not planning to vanish: the roadmap is public, the code is open, and the community decides what comes next.",
  },
  {
    q: "Why macOS-only?",
  ...
  },
  {
    ...
    a: "Keyboard is keyboard. Command palette, familiar editing, native macOS feel. Fifteen minutes and you're home. Your Mac gets a gigabyte of RAM back.",
  },
  {
